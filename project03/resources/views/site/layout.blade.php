...
<!-- FOOTER -->
    <p>&nbsp;</p>
    <footer class="text-center text-dark" style="background-color: slategrey" >
        <p>&nbsp;</p>
        <p class="float-end"><a class="text-white" href="#">Back to top</a></p>
        <p>&copy; <!--<?= date('Y'); ?>--> {{ date ('Y') }} LG Veículos, Inc. &middot; <a class="text-white" href="#">Privacy</a> &middot; <a class="text-white" href="#">Terms</a></p>
        <p>&nbsp;</p>
    </footer>
</main>
